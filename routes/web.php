...
use App\Http\Livewire\Karyawan\DataKaryawanController;
use App\Http\Livewire\Karyawan\DataFormPengajuanController;
// [route_import_path]
...
Route::group(['middleware' => ['auth:sanctum', 'verified', 'user.authorization']], function () {
    ...
    Route::get('/data-form-pengajuan', DataFormPengajuanController::class)->name('data-form-pengajuan');
    // [route_path]
